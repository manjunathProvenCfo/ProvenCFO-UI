    ...
    $('#message-body-input').mentionsInput({
        onDataRequest: function (mode, query, callback) {
            var data = [
                ...
                { id: 10, name: 'Kenneth 1', 'avatar': 'http://cdn0.4dots.com/i/customavatars/avatar7112_1.gif', 'type': 'contact' },
                { id: 11, name: 'Kenneth 2', 'avatar': 'http://cdn0.4dots.com/i/customavatars/avatar7112_1.gif', 'type': 'contact' },
            ];
